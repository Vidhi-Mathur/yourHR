        ...
        <div className="container px-6 md:px-12 grid gap-12">
          ...
          <div className="bg-[#e7f2f6] p-6 rounded-lg shadow-md">
            <form className="grid gap-6" onSubmit={submitHandler}>
              ...
              <button type="submit" className="w-full inline-flex items-center justify-center rounded-md bg-[#F3C3D7] px-6 py-3 font-medium shadow-sm transition-colors hover:bg-black hover:text-[#F3C3D7] focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                Submit
              </button>
            </form>
          </div>
